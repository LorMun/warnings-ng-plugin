...
import io.jenkins.plugins.analysis.warnings.GccContainer;
...
public class DockerITest extends IntegrationTestWithJenkinsPerTest {
    ...
    private DumbSlave createJavaAgent() {
        try {
            ...
            properties.add(new EnvironmentVariablesNodeProperty(new Entry("JAVA_HOME", "/usr/lib/jvm/java-8-openjdk-amd64/jre")));
